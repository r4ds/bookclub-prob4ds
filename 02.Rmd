...
Note that $\mathbb{P}[D_1|M_3] = \mathbb{P}[D_1]$ and is independat of the door opening. So you should switch!  Surprisingly, in a *Mythbusters* episode 20 out of 20 voluneers decided not to switch!
