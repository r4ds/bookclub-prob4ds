...
This problem is inspired by the game show *Let's Make A Deal*. Maybe it should now be called the *Wayne Brady* problem! (It is similar to the *Three Prisoners Problem* described in the book)
